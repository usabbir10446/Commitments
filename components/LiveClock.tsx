    ...
    return (
      <div className="flex items-center gap-2 lg:gap-10">
        ...
        <div className="hidden sm:block text-right">
          <p className="text-[9px] lg:text-xl font-black text-indigo-600 uppercase tracking-tight italic whitespace-nowrap">
            {formatBanglaDate(now)}
          </p>
        </div>

        {/* Central Clock */}
        <div className="flex items-baseline gap-1 lg:gap-3 px-2 lg:px-8 sm:border-x-2 border-slate-100/50">
        ...
        <div className="text-left">
          <p className="text-[8px] lg:text-xl font-black text-slate-900 uppercase tracking-widest whitespace-nowrap leading-tight">
